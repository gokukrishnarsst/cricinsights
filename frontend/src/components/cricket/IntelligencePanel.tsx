  ...
  return (
    <section className="mt-10">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
            ...
            {strengths.map((s) => (
              <li key={s.key} className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <div className="mt-0.5 text-[12.5px] text-ink-soft">{s.evidence}</div>
                </div>
        ...
        {/* Development areas */}
        <SectionCard icon={AlertTriangle} title="Development Areas" tint="text-rose">
          <ul className="space-y-3">
            {gaps.map((g) => (
              <li key={g.key} className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <div className="mt-0.5 text-[12.5px] text-ink-soft">{g.evidence}</div>
                </div>
        ...
        <SectionCard icon={BarChart3} title="Phase Impact" tint="text-accent-2">
          <div className="space-y-4">
            ...
            <p className="text-[11px] leading-relaxed text-ink-faint">
              Phase splits are modelled from career ratios until ball-by-ball
              data is available.
            </p>
          </div>
        </SectionCard>
